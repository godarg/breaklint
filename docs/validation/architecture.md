...
calibrated. It does not change a production threshold, rule implementation, registry entry, package
version or report surface. All 15 rules remain `calibrated: false`.
