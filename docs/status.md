...
<!-- breaklint-status-figures-v1 unitTests=482 aggregateTests=598 liveTests=71 liveReportLeaves=226 s1RasterDiffPx=200 s1ForeignRasterDiffPx=200 -->
...
## Self-authored corpus gate (unreleased)
...
threshold that is wrong for real documents but consistent with its own documentation passes here.
