...
function snapshotFromProjection(projection: SnapshotProjection): Snapshot {
  ...
  return {
    ...
    pages: [],
    blocks: [{ nodeKey: svg.nodeKey, sid: null, authorId: null, blockSignature: "receipt-svg", fragmentIndex: 0, fragmentCount: 1, page: projection.pageNumber, box: svg.viewportScreen, tag: "svg", classList: [], lineHeight: 20, spaceWidth: 4, effectiveStyle: style, display: "inline", marginCopies: 0, float: "none", position: "static", boundaryHyphen: false, lines: [], inertBreak: null }],
