...
function snapshotFromProjection(projection: SnapshotProjection): Snapshot {
  ...
  return {
    ...
    pages: [],
    blocks: [{ nodeKey: svg.nodeKey, sid: null, authorId: null, blockSignature: "receipt-svg", fragmentIndex: 0, fragmentCount: 1, page: projection.pageNumber, box: svg.viewportScreen, tag: "svg", classList: [], lineHeight: 20, spaceWidth: 4, effectiveStyle: style, lines: [], inertBreak: null, atomicBoxes: [], flowHazards: { inside: [], self: [], around: [] } }],
