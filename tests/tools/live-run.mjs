...
const DEFAULT_SPECS = [
  ...
  { file: "tests/live/measure.test.ts", suite: "the measurement probe, live", leaves: 9 },
  ...
  { file: "tests/live/render-run.test.ts", suite: "the M2d live production chain", leaves: 37 },
