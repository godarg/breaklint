...
| G-94 | --allow-network does not limit WebSocket / WebTransport / iframe TCP (pre-existing; SECURITY.md "exactly one origin" overclaims) | C2 r2 verifier | medium (security claim) | open |
